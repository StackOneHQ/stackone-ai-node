...
export const ticketingSpec = {
  ...
  paths: {
        ...
        parameters: [
          ...
          },
          {
            ...
            schema: {
              nullable: true,
              example:
                'id,remote_id,type,name,primary_email,primary_phone,additional_properties,created_at,updated_at',
              type: 'string',
            },
          },
          {
    ...
    '/unified/ticketing/attachments/{id}/download': {
      get: {
      ...
      get: {
        ...
        parameters: [
          ...
          },
          {
            ...
            schema: {
              nullable: true,
              example: 'id,remote_id,name,collection',
              type: 'string',
            },
          },
          {
    ...
    schemas: {
      ...
      TicketingTicketPriorityTypeEnum: {
        ...
        properties: {
          ...
          value: {
            type: 'string',
            enum: ['lowest', 'low', 'medium', 'high', 'highest', null],
      ...
      TicketingTicketStatusTypeEnum: {
        ...
        properties: {
          ...
          value: {
            type: 'string',
            enum: ['to-do', 'in-progress', 'closed', null],
          ...
          source_value: {
            description: 'The source value of the ticket status.',
            example: 'Backlog',
            oneOf: [
              {
                type: 'string',
      ...
      TicketingUser: {
        ...
        properties: {
          ...
          additional_properties: {
            oneOf: [
              {
                $ref: '#/components/schemas/TicketingUserAgentProperties',
              },
              {
                $ref: '#/components/schemas/TicketingUserContactProperties',
              },
            ],
            nullable: true,
          },
      ...
      TicketingUserContactProperties: {
        type: 'object',
        properties: {
          first_name: {
            type: 'string',
